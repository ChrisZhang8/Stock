...
/**
 * Servlet implementation class SaleOrderServlet
 */
public class SaleOrderServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
//	@Autowired
//	private LogicServiceInterface logicService;
      
	private Map<Integer,String> key = new HashMap<Integer,String>();
	private static final String[] keys = new String[]{"PRODUCT","PRODUCT_NAME","BRAND",
			"PACKAGE","BATCH_NO","ORDER_QTY","PRICE","TOTAL_AMOUNT","REMARK"};
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaleOrderServlet() {
        super();
...
//    	SpringBeanAutowiringSupport.processInjectionBasedOnCurrentContext(this);
	...
	public void updateSaleOrder(HttpServletRequest request,
		...
		try {
			...
			this.outPrintJsonText(request, response, "修改订单成功！");
		} catch (Exception e) {
			this.outPrintJsonException(request, response, e.getMessage());
		}
	}
